window.view = {
	...
	validateRightangleTriangleInputs: function() {
		...
		if ( a !== '2')
			alert('Incorrect value of input variables(arguments). Calculating the area of a RightangleTriangle requires the length of the two different  sides of the RightangleTriangle. Try again.')
		else if ( b !== 'float' )
